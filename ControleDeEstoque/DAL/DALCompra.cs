    ...
    public class DALCompra
    {
        ...
        public void Incluir(ModeloCompra modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                ...
                CommandText = "insert into compra(com_data,com_nfiscal,com_total,com_nparcelas," +
        ...
        public void Alterar(ModeloCompra modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "update compra set com_data=@com_data, com_nfiscal=@com_nfiscal," +
        ...
        public void Excluir(int codigo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "delete from compra where com_cod = @codigo;"
            };
        ...
        public int QuantidadeParcelasNaoPagas(int Codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select count(com_cod) from parcelascompra where com_cod = @cod and pco_datapagto is NULL"
            };
        ...
        public DataTable Localizar(DateTime dtinicial, DateTime dtfinal)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "Select c.com_cod,c.com_data,c.com_nfiscal," +
                    "c.com_nparcelas,f.for_nome,c.com_status, c.for_cod, c.tpa_cod, c.com_total" +
                    " from compra c inner join fornecedor f on c.for_cod = f.for_cod" +
        ...
        public ModeloCompra CarregaModeloCompra(int codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select * from compra where com_cod = @codigo"
            };
