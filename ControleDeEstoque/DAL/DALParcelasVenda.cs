    ...
    public class DALParcelasVenda
    {
        ...
        public void Incluir(ModeloParcelasVenda modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                ...
                CommandText = "insert into parcelasvenda(pve_cod,ven_cod,pve_datavecto,pve_valor) values (@pve_cod,@ven_cod,@pve_datavecto,@pve_valor);"
            };
            ...
            cmd.Parameters.Add("@pve_datavecto", SqlDbType.Date);
        ...
        public void Alterar(ModeloParcelasVenda modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "update parcelasvenda set pve_valor = @pve_valor, " +
            ...
            cmd.Parameters.AddWithValue("@ven_cod", modelo.VenCod);
            cmd.Parameters.AddWithValue("@pve_valor", modelo.PveValor);
            cmd.Parameters.Add("@pve_datapagto", SqlDbType.Date);
            cmd.Parameters.Add("@pve_datavecto", SqlDbType.Date);
        ...
        public void Excluir(ModeloParcelasVenda modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "delete from parcelasvenda " +
                     "where pve_cod = @pve_cod and ven_cod = @ven_cod;"
            };
        ...
        public ModeloParcelasVenda CarregaModeloParcelasVenda(int PveCod, int VenCod)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select * from parcelasvenda where pve_cod = @pve_cod and ven_cod = @ven_cod;"
            };
        ...
        public void EfetuaRecebimentoParcela(int venCod, int pveCod, DateTime dtrecebimento)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "update parcelasvenda set pve_datapagto = @pve_datapagto " +
                    "where pve_cod = @pve_cod and ven_cod = @ven_cod;"
            };
