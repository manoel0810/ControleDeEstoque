    ...
    public class DALProduto
    {
        ...
        public void Incluir(ModeloProduto obj)
        {
            SqlCommand cmd = new SqlCommand
            {
                ...
                CommandText = "insert into Produto (pro_nome, pro_descricao, pro_foto,  pro_valorpago, pro_valorvenda, pro_qtde,umed_cod , cat_cod, scat_cod) " +
        ...
        public void Excluir(int codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "delete from Produto where (pro_cod) = (@codigo)"
            };
        ...
        public void Alterar(ModeloProduto obj)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "UPDATE Produto SET pro_nome = (@nome), pro_descricao = (@descricao), " +
        ...
        public ModeloProduto CarregaModeloProduto(int codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select * from Produto where pro_cod =" + codigo.ToString()
            };
