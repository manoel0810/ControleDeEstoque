    ...
    public class DALCategoria
    {
        ...
        public void Incluir(ModeloCategoria modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                ...
                CommandText = "insert into categoria(cat_nome) values (@nome); select @@IDENTITY;"
            };
        ...
        public void Alterar(ModeloCategoria modelo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "update categoria set cat_nome = @nome where cat_cod = @codigo;"
            };
        ...
        public void Excluir(int codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "delete from categoria where cat_cod = @codigo;"
            };
        ...
        public ModeloCategoria CarregaModeloCategoria(int codigo)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select * from categoria where cat_cod = @codigo"
            };
