    ...
    public class DALParcelasCompra
    {
        ...
        public void Incluir(ModeloParcelasCompra modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                ...
                CommandText = "insert into parcelascompra(pco_cod,com_cod,pco_datavecto,pco_valor) values (@pco_cod,@com_cod,@pco_datavecto,@pco_valor);"
            };
            ...
            cmd.Parameters.Add("@pco_datavecto", SqlDbType.Date);
        ...
        public void EfetuaPagamentoParcela(int comCod, int pcoCod, DateTime dtpagto)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "update parcelascompra set pco_datapagto = @pco_datapagto " +
        ...
        public void Alterar(ModeloParcelasCompra modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "update parcelascompra set pco_valor = @pco_valor, " +
            ...
            cmd.Parameters.AddWithValue("@com_cod", modelo.ComCod);
            cmd.Parameters.AddWithValue("@pco_valor", modelo.PcoValor);
            cmd.Parameters.Add("@pco_datapagto", SqlDbType.Date);
            cmd.Parameters.Add("@pco_datavecto", SqlDbType.Date);
        ...
        public void Excluir(ModeloParcelasCompra modelo)
        {
            SqlCommand cmd = new SqlCommand
            {
                Connection = conexao.ObjetoConexao,
                Transaction = conexao.ObjetoTransacao,
                CommandText = "delete from parcelascompra " +
                    "where pco_cod = @pco_cod and com_cod = @com_cod;"
            };
        ...
        public ModeloParcelasCompra CarregaModeloParcelasCompra(int PcoCod, int ComCod)
        {
            ...
            {
                Connection = conexao.ObjetoConexao,
                CommandText = "select * from parcelascompra where pco_cod = @pco_cod and com_cod = @com_cod;"
            };
